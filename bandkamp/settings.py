...
SECRET_KEY = os.getenv('SECRET_KEY', 'Chave não encontrada!')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("DEBUG", False)

ALLOWED_HOSTS = ["projeto-s5-davidkauan04-production.up.railway.app", "0.0.0.0"]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Bandkamp",
    "DESCRIPTION": "API including users, songs and albums!.",
    "VERSION": "1.0.0",
